...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Creating an attribute to save the game condition.
    ...
    def _create_fleet(self):
        ...
        alien = Alien(self)
        # Size attribute will return a tuple of 2 int values containing width and height respectively.
    ...
    def _check_fleet_edges(self):
        """Respond apropriately if aliens have reached the edge of the screen."""
        for alien in self.aliens.sprites():
            if alien.check_edges():
                self._change_fleet_direction()
                
    def _change_fleet_direction(self):
        """Drop the entire fleet and change its direction when hit a screen boundry."""
        for alien in self.aliens.sprites():
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            #Decrement the ships left when ship is hit and update scoreboard.
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= self.settings.screen_height:
                #Treating this case same as when an alien hit the ship.
                self._ship_hit()
                break
    ...
    def _check_play_button(self, mouse_pos):
        ...
        if button_clicked and not self.game_active:
            ...
            # Creating a new fleet and center the ship.
            self._create_fleet()
            self.ship.center_ship()
